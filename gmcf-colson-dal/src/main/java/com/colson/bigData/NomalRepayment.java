...
public class NomalRepayment {
	//正常还款
	public static List<String> nomalRepayment(){
		...
		BigDecimal biddingAmount = new BigDecimal(6000);
		...
		String signingDatetime = "2019-05-15 11:10:45";
		String dealDatetime = "2019-05-15 11:30:45";
		...
		String startDate = "2019-05-17 00:00:00";
		String endDate = "2020-05-17 00:00:00";
		...
		String beforeMustPayDate = "2019-07-15 11:30:45";
		...
		BigDecimal gomeInverstmentAmount = new BigDecimal(60);
		BigDecimal otherInverstementAmount = new BigDecimal(5940);
		String investmentDatetime = "2019-05-15 17:51:48";
		...
		BigDecimal mustPayPrincipal = new BigDecimal(500);
		...
		String valueDate = "2019-05-15 11:30:45";
		String dueDate = "2019-06-15 11:30:45";
		String mustPayDate = "2019-05-15 11:30:45";
		...
		for (int i = 0; i < insertSize; i++) {
			...
			for (;j<2;j++){
				...
				decSb.append("'").append(debitNo+genSimpleUUID()).append(str)
						...
						.append(new BigDecimal(12)).append(",")
