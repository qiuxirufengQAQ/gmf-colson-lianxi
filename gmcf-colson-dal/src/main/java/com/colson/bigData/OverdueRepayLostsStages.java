...
public class OverdueRepayLostsStages {
	//逾期还多期
	public static List<String> overdueRepayLostsStages(){
		...
		String repaymentStatusArray = "*NNN1NNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN";
		...
		for (int i = 0; i < insertSize; i++) {
			...
			for (;j<5;j++){
				...
				if (j == 0){
					...
					actualPayDate = "2019-06-25 00:00:00";
					mustPayInterest = new BigDecimal(13.6);
					actualPayPrincipal = new BigDecimal(1000);
					actualPayInterest = new BigDecimal(13.6);
					debitStatus = 8;
