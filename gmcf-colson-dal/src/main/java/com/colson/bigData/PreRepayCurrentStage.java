...
public class PreRepayCurrentStage {
	//提前还当期
	public static List<String> preRepayCurrentStage(){
		...
		String startDate = "2019-05-15 00:00:00";
		String endDate = "2020-05-15 00:00:00";
		...
		for (int i = 0; i < insertSize; i++) {
			...
			for (;j<2;j++){
				...
				if (j==0){
					...
					actualPayDate = "2019-07-05 00:00:00";
					mustPayInterest = new BigDecimal(10);
					actualPayPrincipal = new BigDecimal(1000);
					actualPayInterest = new BigDecimal(10);
					debitStatus = 4;
				}
