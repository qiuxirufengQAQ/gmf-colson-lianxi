...
public class OverdueNotSettle {
	//逾期提前结清
	public static List<String> overdueNotSettle(){
		...
		String signingDatetime = "2018-02-10 11:10:45";
		String dealDatetime = "2018-02-10 11:30:45";
		...
		Integer currentStage = 12;
		String startDate = "2018-02-10 00:00:00";
		String endDate = "2019-02-10 00:00:00";
		...
		String nextMustPayDate = "2019-02-10 11:30:45";
		Integer extCurrentStage = 17;
		String repaymentStatusArray = "*NNNNNNNNNN12345677NNNNNNNNNNNNNNNNNNNNNNNNNNNN";
		String maxContinuousStartDate = nullTime;
		Integer isGuaranteed = 0;
		String capitalCodes = "0000,C5001";
		String beforeMustPayDate = "2019-01-10 11:30:45";
		...
		String investmentDatetime = "2018-02-10 17:51:48";
		...
		String valueDate = "2018-02-10 11:30:45";
		String dueDate = "2018-03-10 11:30:45";
		String mustPayDate = "2018-02-10 11:30:45";
		...
		for (int i = 0; i < insertSize; i++) {
			...
			for (;j<12;j++){
				...
				if (j == 0){
					actualPayDate = "2018-03-10 00:00:00";
					mustPayInterest = new BigDecimal(13.6);
					actualPayPrincipal = new BigDecimal(1000);
					actualPayInterest = new BigDecimal(13.6);
					debitStatus = 4;
				}else if(j == 1){
					actualPayDate = "2018-04-10 00:00:00";
					mustPayInterest = new BigDecimal(13.6);
					actualPayPrincipal = new BigDecimal(1000);
					actualPayInterest = new BigDecimal(13.6);
					debitStatus = 4;
				}else if(j == 2){
					actualPayDate = "2018-05-10 00:00:00";
					mustPayInterest = new BigDecimal(13.6);
					actualPayPrincipal = new BigDecimal(1000);
					actualPayInterest = new BigDecimal(13.6);
					debitStatus = 4;
				}else if (j == 3){
					actualPayDate = "2018-06-10 00:00:00";
					mustPayInterest = new BigDecimal(13.6);
					actualPayPrincipal = new BigDecimal(1000);
					actualPayInterest = new BigDecimal(13.6);
					debitStatus = 8;
				}else if (j == 4){
					actualPayDate = "2018-07-10 00:00:00";
					mustPayInterest = new BigDecimal(13.6);
					actualPayPrincipal = new BigDecimal(1000);
					actualPayInterest = new BigDecimal(13.6);
					debitStatus = 4;
				}else if (j == 5){
					actualPayDate = "2018-08-10 00:00:00";
					mustPayInterest = new BigDecimal(13.6);
					actualPayPrincipal = new BigDecimal(1000);
					actualPayInterest = new BigDecimal(13.6);
					debitStatus = 4;
				}else if (j == 6){
					actualPayDate = "2018-09-10 00:00:00";
					mustPayInterest = new BigDecimal(13.6);
					actualPayPrincipal = new BigDecimal(1000);
					actualPayInterest = new BigDecimal(13.6);
					debitStatus = 4;
				}else if (j == 7){
					actualPayDate = "2018-10-10 00:00:00";
					mustPayInterest = new BigDecimal(13.6);
					actualPayPrincipal = new BigDecimal(1000);
					actualPayInterest = new BigDecimal(13.6);
					debitStatus = 4;
				}else if (j == 8){
					actualPayDate = "2018-11-10 00:00:00";
					mustPayInterest = new BigDecimal(13.6);
					actualPayPrincipal = new BigDecimal(1000);
					actualPayInterest = new BigDecimal(13.6);
					debitStatus = 4;
				}else if (j == 9){
					actualPayDate = "2018-12-10 00:00:00";
					mustPayInterest = new BigDecimal(13.6);
					actualPayPrincipal = new BigDecimal(1000);
					actualPayInterest = new BigDecimal(13.6);
					debitStatus = 4;
			...
			biddingNo = "gmcfbec";
			loanNo = "gmcfloc";
			valueDate = "2018-02-10 11:30:45";
			dueDate = "2018-03-10 11:30:45";
			mustPayDate = "2018-02-10 11:30:45";
			decCurrentStage = 1;
			debitStatus = 1;
		}
