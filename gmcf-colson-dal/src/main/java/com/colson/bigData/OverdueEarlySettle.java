...
public class OverdueEarlySettle {
	//逾期提前结清
	public static List<String> overdueEarlySettle(){
		...
		Integer shortNo = 1010000000;
		Integer biddingStatus = 4;
		...
		String settleDateTime = "2019-06-18 00:00:00";
		...
		String repaymentStatusArray = "*NNN1CNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN";
		...
		for (int i = 0; i < insertSize; i++) {
			...
			for (;j<4;j++){
				...
				if (j == 0){
					...
					actualPayDate = "2019-06-18 00:00:00";
					mustPayInterest = new BigDecimal(13.6);
					actualPayPrincipal = new BigDecimal(1000);
					actualPayInterest = new BigDecimal(13.6);
					debitStatus = 8;
			...
			//增加一条提前结清的数据
			mustPayDate = "2019-06-18 00:00:00";
			actualPayDate = "2019-06-18 00:00:00";
			mustPayInterest = new BigDecimal(0);
			mustPayPrincipal = new BigDecimal(8000);
			actualPayPrincipal = new BigDecimal(8000);
			actualPayInterest = new BigDecimal(0);
			debitStatus = 6;
			decSb = new StringBuilder();
			decSb.append("'").append(debitNo+genSimpleUUID()).append(str)
