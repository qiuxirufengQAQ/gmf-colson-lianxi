...
public class OverdueCurrentStage {

	//预期未还当期
	public static List<String> overdueCurrentStage(){
		...
		String repaymentStatusArray = "*N1NNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN";
